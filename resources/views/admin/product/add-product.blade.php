            ...
            <div class="well">
                ...
                <form action="{{url('/new-product')}}" method="post" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <textarea  name="short_description" class="form-control textarea" cols="22" rows="5"></textarea>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <textarea  name="long_description" class="form-control textarea" cols="22" rows="10"></textarea>
