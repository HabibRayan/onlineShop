        ...
        <ul class="nav" id="side-menu">
            ...
            <li>
                ...
                <ul class="nav nav-second-level">
                    ...
                    <li>
                        <a href="{{url('/manage-category')}}">Manege Category</a>
                    </li>
                </ul>
                <!-- /.nav-second-level -->
            </li>
            <li>
                ...
                <ul class="nav nav-second-level">
                    ...
                    <li>
                        <a href="{{url('/manage-brand')}}">Manege Brand</a>
                    </li>
                </ul>
                <!-- /.nav-second-level -->
            </li>
            <li>
                ...
                <ul class="nav nav-second-level">
                    ...
                    <li>
                        <a href="{{url('/manage-product')}}">Manege Product</a>
                    </li>
                </ul>
                <!-- /.nav-second-level -->
            </li>
            <li>
                <a href="{{url('/order-info')}}"><i class="fa fa-table fa-fw"></i> Order Info</a>
            </li>
            <li>
